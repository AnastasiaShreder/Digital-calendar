...
INSERT INTO `projects` VALUES (3,'Молодежный карьерный форум — 2020','2020-01-07',1,'Карьерный форум для молодежи!'),(4,'Карьерный форум Fresh Business в Москве','2020-09-09',1,'Fresh Business в Москве!'),(5,'Фестиваль науки, технологий и искусства Geek Picnic','2020-08-08',1,'Фестиваль науки, технологий и искусства!'),(6,'Ежегодная конференция для HR и ИТ-рекрутеров TechRec 2020','2020-10-12',1,'Конференция для HR и ИТ-рекрутеров TechRec 2020.Проходит каждый год!'),(7,'Авиахакатон-2020 онлайн','2020-12-12',1,'Это самый масштабный хакатон в России в авиаиндустрии с международным участием!'),(8,'Онлайн-конференция «Время возможностей»','2020-04-05',0,'Наша локальная конференция,участие по желанию!');
...
INSERT INTO `tasks` VALUES (22,'Обсудить спонсирование с руководством','2020-06-05',NULL,'ff00ff','Нужно обусдить спонсирование проекта с руководством'),(23,'Составить ТЗ для программистов','2020-06-25',NULL,'ff00ff','Программистам нужно Техническое задание для проекта'),(24,'Разослать приглашения партнерам форума','2020-06-25',NULL,'ff00ff','Андрею нужно разослать приглашения партнерам форума'),(25,'Создать группу ВКонтакте','2020-05-01',NULL,'ff00ff','Форуму обязательно нужна группа в вк до 1 мая'),(26,'Обсудить рекламную кампанию','2020-05-06',NULL,'ff00ff','Нужно обсудить как будем рекламировать форум'),(27,'Пригласить работодателей и составить список','2020-08-24',NULL,'ff00ff','Нужно обязательно пригласить работодателей и составить список'),(28,'Договориться об аренде места проведения','2020-08-18',NULL,'ff00ff','Ваня,тебе нужно найти нам место проведения'),(29,'Распространить объявления о поиске волонтеров','2020-08-18',NULL,'ff00ff','Обьявления нужно еще предварительно сверстать'),(30,'Связаться с типографией для обсуждения работ','2020-07-29',NULL,'ff00ff','Телефон типографии спроси у Данила'),(31,'Забрать договор с рестораном','2020-07-30',NULL,'ff00ff','Нужно оформить и забрать договор с рестораном'),(32,'Уточнить дату проведения','2020-07-05',NULL,'ff00ff','Нужно уточнить дату,там возникла некоторая неясность'),(33,'Составить расписание мероприятия','2020-10-12',NULL,'ff00ff','Конференции срочно нужно расписание,до него всего 11 дней!'),(34,'Обсудить максимальное число команд-участников','2020-12-12',NULL,'ff00ff','Нужно определится с количеством команд'),(35,'Утвердить форму заявки','2020-11-18',NULL,'ff00ff','Нужно проверить и утутвердить форму заявки'),(36,'Заказать стенд','2020-11-20',NULL,'ff00ff','Нужно заказать стенд,без этого никак'),(37,'Разослать участникам приглашения по email','2020-03-28',NULL,'ff00ff','Нужно пригласть участникова,иначе как они будут участниками?'),(38,'Протестировать платформу для видеосвязи','2020-04-01',NULL,'ff00ff','Нужно срочно проверить видеосвязь для мероприятия');
...
INSERT INTO `users` VALUES (6,'Анастасия','Шредер','anastasia123','Отдел 1','anastasia.shreder@hh.ru','vk.com/tuladragon'),(7,'Марк','Шерман','mark123','Отдел 1','mark.sherman@hh.ru','vk.com/mark20'),(8,'Андрей','Тагиев','andrey123','Отдел 1','andrey.tagiev@hh.ru','vk.com/andreytagiev'),(9,'Иван','Конев','ivan123','Отдел 1','konev.ivan@hh.ru','vk.com/id270231769'),(10,'Данил','Лялин','danil123','Отдел 1','lyalin.danil@hh.ru','vk.com/esrr247');
...
-- Dump completed on 2020-05-07 20:48:31
